...
Data view for all dashboards: `logs-agentguard.findings-*`.
...
**Fields used**
- `@timestamp`, `host.name`, `agentguard.finding.type`, `agentguard.finding.name`
- `agentguard.risk.level`, `agentguard.risk.score`, `agentguard.allowed`
- `process.name`, `process.executable`, `agentguard.ai.provider`, `event.action`
...
**Fields used**
- `agentguard.mcp.client.name`, `agentguard.mcp.server.name`, `agentguard.mcp.server.command`
- `agentguard.mcp.config.path`, `agentguard.mcp.tools`, `agentguard.mcp.capabilities`
- `agentguard.mcp.risk_reasons`, `host.name`, `agentguard.allowed`, `agentguard.risk.level`
...
**Fields used**
- `agentguard.finding.type`, `agentguard.ai.local_service`, `agentguard.ai.provider`
- `agentguard.ai.endpoint`, `destination.ip`, `destination.port`
- `process.name`, `process.executable`, `host.name`, `agentguard.risk.level`
...
**Fields used**
- `agentguard.browser.name`, `agentguard.browser.profile`
- `agentguard.extension.id`, `agentguard.extension.name`, `agentguard.extension.version`
- `agentguard.extension.permissions`, `agentguard.extension.host_permissions`
- `agentguard.extension.risk_reasons`, `host.name`, `agentguard.risk.level`
...
**Fields used**
- `agentguard.cyber_agent.activity_type`, `agentguard.cyber_agent.capabilities`
- `agentguard.cyber_agent.security_tools`, `agentguard.cyber_agent.suspicious_keywords`
- `agentguard.cyber_agent.target_paths`, `agentguard.cyber_agent.mitre_tactics`
- `agentguard.cyber_agent.mitre_techniques`, `agentguard.finding.type`
- `host.name`, `process.name`, `agentguard.risk.level`
...
- `agentguard.ingest.error.message`, `error.message`
