...
The AgentGuard endpoint scanner is a separate product. This repository contains only the Elastic integration package that configures Elastic Agent to read scanner-produced NDJSON findings and sends them through the package ingest pipeline.
