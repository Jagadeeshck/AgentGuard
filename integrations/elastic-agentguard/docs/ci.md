...
Development-only assets must live outside the package directory at `repo-root/dev-assets/integrations/elastic-agentguard/`.
Do not add `dev-assets/` inside `integrations/elastic-agentguard/`; this violates Elastic package-spec directory rules.
